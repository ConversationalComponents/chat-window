...
var Header = function (p) {
    var _a = useState(p.title), title = _a[0], setTitle = _a[1];
    useEffect(function () {
        setTitle(p.title);
    }, [p.title]);
...
var BubbleContentContainer = function (p) {
    return (React.createElement("div", { className: "bubbleAnimation", style: {
...
var Loading = function () { return (React.createElement("span", null,
    React.createElement(LoadingStep, { delay: "0s" }, "."),
    React.createElement(LoadingStep, { delay: ".2s" }, "."),
    React.createElement(LoadingStep, { delay: ".4s" }, "."))); };
...
var css$2 = ".imageAnimation {\r\n    animation: scale 0.3s ease forwards;\r\n}\r\n\r\n@keyframes scale {\r\n    100% {\r\n        transform: scale(1);\r\n    }\r\n}\r\n";
styleInject(css$2);

var Image = function (p) {
    return (React.createElement("img", { src: p.src, style: {
...
var ChatBubble = function (p) {
    var avatar = p.entry.avatar;
    var _a = useState(p.entry.id), id = _a[0], setId = _a[1];
    useEffect(function () {
        setId(p.entry.id);
    }, [p.entry.id]);
    var _b = useState(!!p.entry.isLoading), isLoading = _b[0], setIsLoading = _b[1];
    useEffect(function () { return autorun(function () { return setIsLoading(!!p.entry.isLoading); }); }, []);
    var _c = useState(p.entry.message), message = _c[0], setMessage = _c[1];
    useEffect(function () {
        return autorun(function () {
    ...
    var _d = useState(p.entry.isUser), isUser = _d[0], setIsUser = _d[1];
    useEffect(function () {
        setIsUser(p.entry.isUser);
    }, [p.entry.isUser]);
    var _e = useState(true), isFirst = _e[0], setIsFirst = _e[1];
    useEffect(function () {
        setIsFirst(true); // this is here for future implementation
    }, []);
    var _f = useState(true), isLast = _f[0], setIsLast = _f[1];
    useEffect(function () {
    ...
    return (React.createElement("div", { ref: ref, style: {
        ...
        React.createElement(ImageContainer, { isUser: isUser }, React.createElement(Image, { isUser: isUser, src: avatar })),
        React.createElement(BubbleContentContainer, { id: id, isUser: isUser, isFirst: isFirst, isLast: isLast }, isLoading ? React.createElement(Loading, null) : message),
        p.endElement));
};
...
const ActionButton = ({color, children, invalid, disabled, onTouchStart, onTouchCancel, onTouchEnd}) => {
    const ref = useRef();
    useEffect(() => {
...
var ConfirmTextButton = function (p) {
    var _a = useState(!!p.inputInvalid), inputInvalid = _a[0], setInputInvalid = _a[1];
    var _b = useState(!!p.disabled), disabled = _b[0], setDisabled = _b[1];
    useEffect(function () { return setDisabled(!!p.disabled); }, [p.disabled]);
    useEffect(function () { return setInputInvalid(!!p.inputInvalid); }, [p.inputInvalid]);
    var onTouchStart = function () { };
    var onTouchCancel = function () { };
    var onTouchEnd = function () {
        p.onSubmit();
    };
    return (React.createElement(ActionButton, __assign({}, { color: undefined, disabled: disabled, invalid: inputInvalid, onTouchStart: onTouchStart, onTouchCancel: onTouchCancel, onTouchEnd: onTouchEnd }),
        React.createElement("svg", { style: { height: "24px", width: "24px" } },
            React.createElement("path", { d: "M2,21L23,12L2,3V10L17,12L2,14V21Z" }))));
};

var FooterInput = function (p) {
    ...
    var _a = useState(false), inputInvalid = _a[0], setIsInputInvalid = _a[1];
    var _b = useState(p.inputPlaceholder), inputPlaceholder = _b[0], setInputPlaceholder = _b[1];
    var _c = useState(""), value = _c[0], setValue = _c[1];
    var _d = useState(!!p.disabled), disabled = _d[0], setDisabled = _d[1];
    var _e = useState(false), isRefocusing = _e[0], setisRefocusing = _e[1];
    useEffect(function () {
    ...
    var _f = useState(p.actionButton || React.createElement(ConfirmTextButton, { onSubmit: onClickSubmit })), actionButton = _f[0], setActionButton = _f[1];
    useEffect(function () {
        setActionButton(p.actionButton || React.createElement(ConfirmTextButton, { onSubmit: onClickSubmit }));
    ...
    return (React.createElement("div", { style: { position: "relative" } },
        React.createElement(Input, __assign({}, { isRefocusing: isRefocusing, inputInvalid: inputInvalid, inputPlaceholder: inputPlaceholder, onKeyPress: onKeyPress, onChange: onChange, value: value, disabled: disabled })),
        actionButton));
};
 ...
 */
var ChatWindow = function (p) {
    var CustomBubble = p.bubble;
    var _a = useState(p.content), content = _a[0], setContent = _a[1];
    useEffect(function () { return setContent(p.content); }, [p.content]);
    var _b = useState(p.title), title = _b[0], setTitle = _b[1];
    useEffect(function () { return setTitle(p.title); }, [p.title]);
    var _c = useState([]), bubbles = _c[0], setBubbles = _c[1];
    useEffect(function () {
        var newBubbles = [];
        content.forEach(function (c, i) {
            var bubble = CustomBubble ? (React.createElement(CustomBubble, __assign({}, { entry: c, bubbleExtraParams: p.bubbleExtraParams }, { key: c.id }))) : (React.createElement(ChatBubble, __assign({}, { entry: c, bubbleExtraParams: p.bubbleExtraParams }, { key: c.id })));
            newBubbles.push(bubble);
        });
        setBubbles(newBubbles);
    }, [content]);
    return (React.createElement(ChatBotContainer, null,
        p.header ? p.header : React.createElement(Header, { title: title || "", extraContent: p.headerAdditionalContent }),
        React.createElement(ChatBody, null, bubbles),
        p.footer ? (p.footer) : (React.createElement(FooterInput, __assign({}, { onSubmit: p.onSubmit ? p.onSubmit : function (t) { }, inputPlaceholder: "Type here" })))));
};
