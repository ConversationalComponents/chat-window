...
exports.ChatWindow = function (p) {
    ...
    var content = p.content, title = p.title, header = p.header;
    var _a = react_1.useState([]), bubbles = _a[0], setBubbles = _a[1];
    react_1.useEffect(function () {
        var newBubbles = [];
        content.forEach(function (c, i) {
            var bubbles = CustomBubble ? (react_1.default.createElement(CustomBubble, __assign({}, { entry: c, bubbleExtraParams: p.bubbleExtraParams }, { key: c.id }))) : (react_1.default.createElement(ChatBubble_1.ChatBubble, __assign({}, { entry: c, bubbleExtraParams: p.bubbleExtraParams }, { key: c.id })));
