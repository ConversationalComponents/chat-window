...
exports.FooterInput = function (p) {
    ...
    return (react_1.default.createElement("div", { style: { position: "relative" } },
        react_1.default.createElement(Input_1.default, __assign({}, { isRefocusing: isRefocusing, inputInvalid: inputInvalid, inputPlaceholder: inputPlaceholder, onKeyPress: onKeyPress, onChange: onChange, value: value, disabled: disabled })),
        actionButton));
};
