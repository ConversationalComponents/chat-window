...
var Input = function (p) {
    var inputInvalid = p.inputInvalid, inputPlaceholder = p.inputPlaceholder, onKeyPress = p.onKeyPress, onChangeHandler = p.onChangeHandler, disabled = p.disabled, value = p.value, onFocusHandler = p.onFocusHandler;
