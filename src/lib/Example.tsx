...
const botReplies = [
    [
        ...
        {
            text:
                "אני מאזין לפיוט 'עזר מצרי', נהנה מההאזנה הפסיבית שלי לביצוע. טון המזמרים מדגיש את האותיות ט' וְ ק' עמוק מתוך החיך במיומנות שנעלמה מהדור הצעיר וכמובן מילדי וממני. משהו מיוחד בביטוי המילים - החיריק תחת האות ש' במילה שִׁמְךָ, אינו מבוטא כמו E, הוא הרבה יותר קרוב לשוָא. לכן המזמר העירקי שר: שְׁמְךָ. כמו הבבלים שפוגשים בבית כנסת מנחת יהודה בקרבת שוק מחנה יהודה בירושלים. גם בהיגוי ",
            image: "",
        },
